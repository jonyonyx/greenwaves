...
A signalized intersection, or network of intersections, have a number of key parameters, which are essential to the performance of the intersection.
...
\item Political objectives: safety, priority to businesses, reduction of emmisions
\end{itemize}
