RHODES approach to traffic signal optimization is a hierarchical one with 3 layers of detail, see figure \ref{fig:rhodes_hierarchi}. They can be roughly be summarized accordingly:
