...
An expression for estimation of the delays incurred at an intersection was given by Webster. Th estimate is an approximate formula for for isolated intersection with a fixed timing plan under steady state and undersaturated conditions ie. the flow cannot be dynamic and the inflow. 
