...
As DOGS will naturally cause decreased performance for the minor roads it was decided to split the dataset so that \textit{arterial} and \textit{crossing} traffic can be distinguished. For travel timings arterial traffic is defined as traffic which enters or leaves the network by one of the ends of the arterial (north or south). All other traffic is marked as crossing.
