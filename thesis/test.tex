...
In Vissim it is possible to see delays per vehicle type, which in Figure \ref{fig:bus_delay} is used to filter out delays for buses.

\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.40]{delay_bus.PNG} 
\end{center}
\caption{Delay for buses in each test case}
\label{fig:bus_delay}
\end{figure}
