...
\subsection{Favoring closely distanced intersections}
Closely distanced intersections must obtain the most attention in coordination since 1) they are closely distanced and queues cannot be very long before reaching back to the downstream intersection and 2) the travel time between the intersections is more predictable since platoons do not have much time to form as they do on longer stretches of intermediate road.
